...
prompt Run Functions scripts...
prompt ====================
---------------------------------
--Включить все файлы из папки [схема] с расширением .fnc
--@@[схема]/[имя_файла]
--пример
@@credmon/pwf_export.fnc

prompt Run Procedures scripts...
prompt ====================
---------------------------------
--Включить все файлы из папки [схема] с расширением .prc
--@@[схема]/[имя_файла]
--пример
@@credmon/pwf_export.prc

prompt Run Types scripts...
prompt ====================
---------------------------------
--Включить все файлы из папки [схема] с расширением .tps
--@@[схема]/[имя_файла]
--пример
@@credmon/pwf_export.tps

prompt Run Types bodies scripts...
prompt ====================
---------------------------------
--Включить все файлы из папки [схема] с расширением .tpb
--@@[схема]/[имя_файла]
--пример
@@credmon/pwf_export.tpb

prompt Run Triggers scripts...
prompt ====================
---------------------------------
--Включить все файлы из папки [схема] с расширением .trg
--@@[схема]/[имя_файла]
--пример
@@credmon/pwf_export.trg

prompt Run Scripts scripts...
prompt ====================
---------------------------------
--Включить все файлы из папки [схема] с расширением .sql
--@@[схема]/[имя_файла]
--пример
@@credmon/pwf_export.sql
